...
class AddProductUseCaseTest {
    ...
    void setUp() {
        ...
        useCase = new AddProductToOrderUseCase();
    }
    ...
    void shouldReturnOrderDTOWithCorrectStatus() {
        ...
        when(orderGateway.findByIdForUpdate(order.getId())).thenReturn(order);
        ...
        // Act
        OrderDTO result =
                useCase.execute(orderGateway, productUseCase, order.getId(), productId, 2L);
